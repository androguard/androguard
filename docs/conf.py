# -*- coding: utf-8 -*-
#
# Androguard documentation build configuration file, created by
...
from androguard import __version__ as androguardversion
...
# of the sidebar.
#
html_logo = "androguard.png"

# The name of an image file (relative to this directory) to use as a favicon of
# the docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
#
html_favicon = os.path.join("..", "androguard", "gui", "androguard.ico")
...
htmlhelp_basename = 'Androguarddoc'
