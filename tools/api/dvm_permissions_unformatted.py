PERMISSIONS = {
    ...
    "AUTHENTICATE_ACCOUNTS": {
        "android.accounts.AccountManager": [
            ["F", "addAccountExplicitly(android.accounts.Account, java.lang.String, android.os.Bundle)",
             "public boolean"],
            ["F", "getPassword(android.accounts.Account)",
             "public String"],
    ...
    "ACCESS_MOCK_LOCATION": {
        "android.location.LocationManager": [
            ...
            ["F",
             "clearTestProviderEnabled(java.lang.String)", "public void"],
            ["F",
             "clearTestProviderLocation(java.lang.String)", "public void"],
            ["F",
             "clearTestProviderStatus(java.lang.String)", "public void"],
            ["F", "removeTestProvider(java.lang.String)", "public void"],
            ["F",
             "setTestProviderEnabled(java.lang.String, boolean)", "public void"],
            ["F",
             "setTestProviderLocation(java.lang.String, android.location.Location)", "public void"],
            ["F",
             "setTestProviderStatus(java.lang.String, int, android.os.Bundle, long)", "public void"],
        ],
    },
    ...
    "VIBRATE": {
        ...
        "android.media.AudioManager": [
            ...
            ["C", "VIBRATE_SETTING_CHANGED_ACTION",
    ...
    "BROADCAST_STICKY": {
        ...
        "android.content.ContextWrapper": [
            ["F",
                "removeStickyBroadcast(android.content.Intent)", "public void"],
            ["F",
             "sendStickyBroadcast(android.content.Intent)", "public void"],
        ],
    },
    ...
    "MANAGE_ACCOUNTS": {
        "android.accounts.AccountManager": [
            ...
            ["F", "clearPassword(android.accounts.Account)",
             "public void"],
            ...
            ["F", "editProperties(java.lang.String, android.app.Activity, android.accounts.AccountManagerCallback<android.os.Bundle>, android.os.Handler)",
            ...
            ["F",
             "invalidateAuthToken(java.lang.String, java.lang.String)", "public void"],
            ["F", "removeAccount(android.accounts.Account, android.accounts.AccountManagerCallback<java.lang.Boolean>, android.os.Handler)",
             "public AccountManagerFuture"],
    ...
    "NFC": {
        ...
        "android.nfc.NfcAdapter": [
            ...
            ["F",
             "disableForegroundDispatch(android.app.Activity)", "public void"],
            ["F",
             "disableForegroundNdefPush(android.app.Activity)", "public void"],
            ...
            ["F",
             "enableForegroundNdefPush(android.app.Activity, android.nfc.NdefMessage)", "public void"],
        ...
        "android.nfc.tech.NdefFormatable": [
            ...
            ["F", "formatReadOnly(android.nfc.NdefMessage)",
             "public void"],
        ],
        ...
        "android.nfc.tech.MifareClassic": [
            ...
            ["F",
             "authenticateSectorWithKeyA(int, byte[])", "public boolean"],
            ["F",
             "authenticateSectorWithKeyB(int, byte[])", "public boolean"],
            ["F", "close()", "public void"],
            ["F", "connect()", "public void"],
        ...
        "android.nfc.tech.Ndef": [
            ...
            ["F", "writeNdefMessage(android.nfc.NdefMessage)",
             "public void"],
        ],
    ...
    "DUMP": {
        "android.os.Debug": [
            ["F", "dumpService(java.lang.String, java.io.FileDescriptor, java.lang.String[])",
    ...
    "USE_CREDENTIALS": {
        "android.accounts.AccountManager": [
            ["F",
                "blockingGetAuthToken(android.accounts.Account, java.lang.String, boolean)", "public String"],
            ...
            ["F", "getAuthToken(android.accounts.Account, java.lang.String, boolean, android.accounts.AccountManagerCallback<android.os.Bundle>, android.os.Handler)",
             "public AccountManagerFuture"],
            ["F",
             "invalidateAuthToken(java.lang.String, java.lang.String)", "public void"],
        ],
    ...
    "READ_HISTORY_BOOKMARKS": {
        "android.provider.Browser": [
            ...
            ["F", "addSearchUrl(android.content.ContentResolver, java.lang.String)",
            ...
            ["F", "getAllVisitedUrls(android.content.ContentResolver)",
             "public static final Cursor"],
            ["F", "requestAllIcons(android.content.ContentResolver, java.lang.String, android.webkit.WebIconDatabase.IconListener)",
             "public static final void"],
            ["F", "truncateHistory(android.content.ContentResolver)",
             "public static final void"],
            ["F", "updateVisitedHistory(android.content.ContentResolver, java.lang.String, boolean)",
             "public static final void"],
        ],
    },
    ...
    "BLUETOOTH": {
        ...
        "android.bluetooth.BluetoothAdapter": [
            ...
            ["F", "isEnabled()", "public boolean"],
            ["F", "listenUsingInsecureRfcommWithServiceRecord(java.lang.String, java.util.UUID)",
             "public BluetoothServerSocket"],
            ["F", "listenUsingRfcommWithServiceRecord(java.lang.String, java.util.UUID)",
             "public BluetoothServerSocket"],
            ["F", "setName(java.lang.String)", "public boolean"],
            ["F", "startDiscovery()", "public boolean"],
        ],
        "android.bluetooth.BluetoothProfile": [
            ...
            ["F", "getConnectionState(android.bluetooth.BluetoothDevice)",
             "public abstract int"],
            ["F",
             "getDevicesMatchingConnectionStates(int[])", "public abstract List"],
        ],
        "android.bluetooth.BluetoothHeadset": [
            ...
            ["F",
             "getConnectionState(android.bluetooth.BluetoothDevice)", "public int"],
            ["F",
             "getDevicesMatchingConnectionStates(int[])", "public List"],
            ["F", "isAudioConnected(android.bluetooth.BluetoothDevice)",
             "public boolean"],
            ["F",
             "startVoiceRecognition(android.bluetooth.BluetoothDevice)", "public boolean"],
        ...
        "android.bluetooth.BluetoothDevice": [
            ...
            ["F",
             "createInsecureRfcommSocketToServiceRecord(java.util.UUID)", "public BluetoothSocket"],
            ["F",
             "createRfcommSocketToServiceRecord(java.util.UUID)", "public BluetoothSocket"],
    ...
    "WRITE_HISTORY_BOOKMARKS": {
        "android.provider.Browser": [
            ...
            ["F", "clearSearches(android.content.ContentResolver)",
             "public static final void"],
            ["F", "deleteFromHistory(android.content.ContentResolver, java.lang.String)",
             "public static final void"],
            ["F", "deleteHistoryTimeFrame(android.content.ContentResolver, long, long)",
             "public static final void"],
            ["F", "truncateHistory(android.content.ContentResolver)",
             "public static final void"],
            ["F", "updateVisitedHistory(android.content.ContentResolver, java.lang.String, boolean)",
    ...
    "GET_ACCOUNTS": {
        "android.accounts.AccountManager": [
            ...
            ["F", "getAccountsByType(java.lang.String)",
             "public Account[]"],
            ["F", "getAccountsByTypeAndFeatures(java.lang.String, java.lang.String[], android.accounts.AccountManagerCallback<android.accounts.Account[]>, android.os.Handler)",
             "public AccountManagerFuture"],
            ["F", "hasFeatures(android.accounts.Account, java.lang.String[], android.accounts.AccountManagerCallback<java.lang.Boolean>, android.os.Handler)",
             "public AccountManagerFuture"],
        ],
    },
