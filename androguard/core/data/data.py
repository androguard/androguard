...
class Data(object):
    ...
    def export_methods_to_gml(self):
        ...
        for node in self.gvmx.G.nodes():
            print(self.gvmx.nodes_id[node].method_name,
                  self.gvmx.nodes_id[node].get_attributes())
            ...
            for method in _class.get_methods():
                ...
                for i in mx.basic_blocks.get():
                    ...
                    if i.exception_analysis != None:
                        ...
                        buff_nodes += self.add_exception_node(
                            i.exception_analysis, id_exceptions)
                        buff_edges += self.add_edge(None,
                                                    id_exceptions, None, id_i, l_eid, 2)

                buff_edges += self.add_edge(None, id_method,
                                            None, id_method + 1, l_eid, 2)
