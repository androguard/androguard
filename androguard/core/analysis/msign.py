...
from androguard.core.analysis.libsign import libsign
from androguard.core.similarity import similarity
...
class CSignature :
    ...
    def check_db(self, output) :
        ...
        s = similarity.SIMILARITY( "androguard/core/similarity/libsimilarity/libsimilarity.so" )
