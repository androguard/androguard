...
public class TestActivity extends Activity {
    ...
    public int test_base(int _value, int _value2) {
        ...
        switch(this.value) {
           case 0 : this.value2 = this.pouet(); break;
           default : this.value2 = this.pouet2();
        }
        
        switch(this.value) {
           case 1 : this.value2 = this.pouet(); break;
           case 2 : this.value2 = this.pouet2(); break;
    ...
    public static void testDouble( ) {
    	...
    	float xabc = (float) 65534.50;
    	float xdef = (float) 65535.50;
    	float xghi = (float) 65536.50;
    	float xjkl = (float) 65537.50;
    	
    	float xmno = (float) 32769.50;
    	float xpqr = (float) 32768.50;
    	float xstu = (float) 32767.50;
    	float xvwx = (float) 32766.50;
    }
